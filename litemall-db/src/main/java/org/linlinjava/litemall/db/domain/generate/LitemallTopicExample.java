...
public class LitemallTopicExample {
    ...
    public LitemallTopicExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallTopicExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallTopicExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallTopicExample example);
    }
}