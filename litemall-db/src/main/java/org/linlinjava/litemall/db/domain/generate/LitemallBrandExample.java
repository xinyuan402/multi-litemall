...
public class LitemallBrandExample {
    ...
    public LitemallBrandExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallBrandExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallBrandExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallBrandExample example);
    }
}