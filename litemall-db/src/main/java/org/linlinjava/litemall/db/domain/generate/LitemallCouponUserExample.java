...
public class LitemallCouponUserExample {
    ...
    public LitemallCouponUserExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallCouponUserExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallCouponUserExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallCouponUserExample example);
    }
}