...
public class LitemallGoodsAttributeExample {
    ...
    public LitemallGoodsAttributeExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallGoodsAttributeExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallGoodsAttributeExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallGoodsAttributeExample example);
    }
}