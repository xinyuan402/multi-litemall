...
public class LitemallSystemExample {
    ...
    public LitemallSystemExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallSystemExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallSystemExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallSystemExample example);
    }
}