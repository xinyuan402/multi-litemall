...
public class LitemallAftersaleExample {
    ...
    public LitemallAftersaleExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallAftersaleExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallAftersaleExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallAftersaleExample example);
    }
}