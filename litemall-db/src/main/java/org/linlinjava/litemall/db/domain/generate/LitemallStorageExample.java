...
public class LitemallStorageExample {
    ...
    public LitemallStorageExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallStorageExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallStorageExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallStorageExample example);
    }
}