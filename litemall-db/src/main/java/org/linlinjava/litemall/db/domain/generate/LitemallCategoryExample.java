...
public class LitemallCategoryExample {
    ...
    public LitemallCategoryExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallCategoryExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallCategoryExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallCategoryExample example);
    }
}