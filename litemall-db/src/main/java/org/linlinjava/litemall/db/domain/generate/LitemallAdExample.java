...
public class LitemallAdExample {
    ...
    public LitemallAdExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallAdExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallAdExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallAdExample example);
    }
}