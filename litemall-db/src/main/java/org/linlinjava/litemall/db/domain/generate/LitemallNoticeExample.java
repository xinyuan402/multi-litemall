...
public class LitemallNoticeExample {
    ...
    public LitemallNoticeExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallNoticeExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallNoticeExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallNoticeExample example);
    }
}