...
public class LitemallGrouponRulesExample {
    ...
    public LitemallGrouponRulesExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallGrouponRulesExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallGrouponRulesExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallGrouponRulesExample example);
    }
}