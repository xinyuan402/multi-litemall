...
public class LitemallGoodsExample {
    ...
    public LitemallGoodsExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallGoodsExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallGoodsExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallGoodsExample example);
    }
}