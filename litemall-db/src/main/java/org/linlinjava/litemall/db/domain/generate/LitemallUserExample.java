...
public class LitemallUserExample {
    ...
    public LitemallUserExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallUserExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallUserExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallUserExample example);
    }
}