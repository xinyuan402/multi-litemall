...
public class LitemallSearchHistoryExample {
    ...
    public LitemallSearchHistoryExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallSearchHistoryExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallSearchHistoryExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallSearchHistoryExample example);
    }
}