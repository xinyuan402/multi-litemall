...
public class LitemallFeedbackExample {
    ...
    public LitemallFeedbackExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallFeedbackExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallFeedbackExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallFeedbackExample example);
    }
}