...
public class LitemallGoodsProductExample {
    ...
    public LitemallGoodsProductExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallGoodsProductExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallGoodsProductExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallGoodsProductExample example);
    }
}