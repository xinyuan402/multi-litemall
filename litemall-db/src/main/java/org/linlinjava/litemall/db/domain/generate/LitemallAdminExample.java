...
public class LitemallAdminExample {
    ...
    public LitemallAdminExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallAdminExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallAdminExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallAdminExample example);
    }
}