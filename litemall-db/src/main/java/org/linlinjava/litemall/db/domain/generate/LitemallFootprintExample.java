...
public class LitemallFootprintExample {
    ...
    public LitemallFootprintExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallFootprintExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallFootprintExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallFootprintExample example);
    }
}