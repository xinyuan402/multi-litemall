...
public class LitemallKeywordExample {
    ...
    public LitemallKeywordExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallKeywordExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallKeywordExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallKeywordExample example);
    }
}