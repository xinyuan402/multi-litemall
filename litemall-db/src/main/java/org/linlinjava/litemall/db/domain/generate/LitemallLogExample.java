...
public class LitemallLogExample {
    ...
    public LitemallLogExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallLogExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallLogExample page(Integer page, Integer pageSize) {
