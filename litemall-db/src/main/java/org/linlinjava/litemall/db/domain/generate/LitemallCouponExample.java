...
public class LitemallCouponExample {
    ...
    public LitemallCouponExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallCouponExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallCouponExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallCouponExample example);
    }
}