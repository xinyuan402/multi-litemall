...
public class LitemallOrderExample {
    ...
    public LitemallOrderExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallOrderExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallOrderExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallOrderExample example);
    }
}