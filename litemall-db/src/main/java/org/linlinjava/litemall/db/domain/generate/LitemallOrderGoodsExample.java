...
public class LitemallOrderGoodsExample {
    ...
    public LitemallOrderGoodsExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallOrderGoodsExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallOrderGoodsExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallOrderGoodsExample example);
    }
}