...
public class LitemallAddressExample {
    ...
    public LitemallAddressExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallAddressExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallAddressExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallAddressExample example);
    }
}