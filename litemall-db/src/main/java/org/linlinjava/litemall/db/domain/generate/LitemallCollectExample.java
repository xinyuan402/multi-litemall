...
public class LitemallCollectExample {
    ...
    public LitemallCollectExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallCollectExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallCollectExample page(Integer page, Integer pageSize) {
    ...
    public interface IExampleWhen {
        void example(org.linlinjava.litemall.db.domain.generate.LitemallCollectExample example);
    }
}