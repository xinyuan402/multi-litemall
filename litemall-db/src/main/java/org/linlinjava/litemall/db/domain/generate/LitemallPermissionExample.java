...
public class LitemallPermissionExample {
    ...
    public LitemallPermissionExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallPermissionExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallPermissionExample page(Integer page, Integer pageSize) {
