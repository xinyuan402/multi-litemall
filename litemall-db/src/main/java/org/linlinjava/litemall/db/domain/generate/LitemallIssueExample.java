...
public class LitemallIssueExample {
    ...
    public LitemallIssueExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public LitemallIssueExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public LitemallIssueExample page(Integer page, Integer pageSize) {
