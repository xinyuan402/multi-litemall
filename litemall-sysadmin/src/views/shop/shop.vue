<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /sysadmin/shop/list']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
      <el-button v-permission="['POST /sysadmin/shop/create']" class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">添加</el-button>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="操作" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /sysadmin/shop/update']" type="primary" size="mini" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-permission="['POST /sysadmin/shop/delete']" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>

          <el-button v-permission="['POST /sysadmin/shop/changeStatus']" type="danger" size="mini" @click="handleChangeStatus(scope.row, 'NORMAL')">审核通过</el-button>
          <el-button v-permission="['POST /sysadmin/shop/changeStatus']" type="danger" size="mini" @click="handleChangeStatus(scope.row, 'FREEZE')">冻结</el-button>
        </template>
      </el-table-column>
    </el-table>
