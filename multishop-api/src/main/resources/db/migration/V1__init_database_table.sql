...
--
-- Table structure for table `multimall_ad`
--

use multimall;

DROP TABLE IF EXISTS `multimall_ad`;

CREATE TABLE `multimall_ad` (
...
--
-- Table structure for table `multimall_address`
--

DROP TABLE IF EXISTS `multimall_address`;

CREATE TABLE `multimall_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin`
--

DROP TABLE IF EXISTS `multimall_admin`;

CREATE TABLE `multimall_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin_log`
--

DROP TABLE IF EXISTS `multimall_admin_log`;

CREATE TABLE `multimall_admin_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin_notice`
--

DROP TABLE IF EXISTS `multimall_admin_notice`;

CREATE TABLE `multimall_admin_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin_notice_admin`
--

DROP TABLE IF EXISTS `multimall_admin_notice_admin`;

CREATE TABLE `multimall_admin_notice_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin_permission`
--

DROP TABLE IF EXISTS `multimall_admin_permission`;

CREATE TABLE `multimall_admin_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_admin_role`
--
...
--
-- Table structure for table `multimall_sysadmin`
--

DROP TABLE IF EXISTS `multimall_sysadmin`;

CREATE TABLE `multimall_sysadmin` (
                                   `id` int(11) NOT NULL AUTO_INCREMENT,
                                   `username` varchar(63) NOT NULL DEFAULT '' COMMENT '管理员名称',
                                   `password` varchar(63) NOT NULL DEFAULT '' COMMENT '管理员密码',
                                   `last_login_ip` varchar(63) DEFAULT '' COMMENT '最近一次登录IP地址',
...
--
-- Table structure for table `multimall_sysadmin_log`
--

DROP TABLE IF EXISTS `multimall_sysadmin_log`;

CREATE TABLE `multimall_sysadmin_log` (
                                       `id` int(11) NOT NULL AUTO_INCREMENT,
                                       `sysadmin` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管理员',
                                       `ip` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管理员地址',
                                       `type` int(11) DEFAULT NULL COMMENT '操作分类',
                                       `action` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作动作',
                                       `status` tinyint(1) DEFAULT NULL COMMENT '操作状态',
...
--
-- Table structure for table `multimall_sysadmin_notice`
--

DROP TABLE IF EXISTS `multimall_sysadmin_notice`;

CREATE TABLE `multimall_sysadmin_notice` (
                                          `id` int(11) NOT NULL AUTO_INCREMENT,
                                          `title` varchar(63) DEFAULT NULL COMMENT '通知标题',
                                          `content` varchar(511) DEFAULT NULL COMMENT '通知内容',
                                          `sysadmin_id` int(11) DEFAULT '0' COMMENT '创建通知的管理员ID，如果是系统内置通知则是0.',
                                          `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                          `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                          `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
                                          PRIMARY KEY (`id`)
...
--
-- Table structure for table `multimall_sysadmin_notice_sysadmin`
--

DROP TABLE IF EXISTS `multimall_sysadmin_notice_sysadmin`;

CREATE TABLE `multimall_sysadmin_notice_sysadmin` (
                                                `id` int(11) NOT NULL AUTO_INCREMENT,
                                                `notice_id` int(11) DEFAULT NULL COMMENT '通知ID',
                                                `notice_title` varchar(63) DEFAULT NULL COMMENT '通知标题',
                                                `sysadmin_id` int(11) DEFAULT NULL COMMENT '接收通知的管理员ID',
                                                `read_time` datetime DEFAULT NULL COMMENT '阅读时间，如果是NULL则是未读状态',
                                                `add_time` datetime DEFAULT NULL COMMENT '创建时间',
                                                `update_time` datetime DEFAULT NULL COMMENT '更新时间',
                                                `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
...
--
-- Table structure for table `multimall_sysadmin_permission`
--

DROP TABLE IF EXISTS `multimall_sysadmin_permission`;

CREATE TABLE `multimall_sysadmin_permission` (
                                              `id` int(11) NOT NULL AUTO_INCREMENT,
                                              `role_id` int(11) DEFAULT NULL COMMENT '角色ID',
                                              `permission` varchar(63) DEFAULT NULL COMMENT '权限',
                                              `add_time` datetime DEFAULT NULL COMMENT '创建时间',
...
--
-- Table structure for table `multimall_sysadmin_role`
--

DROP TABLE IF EXISTS `multimall_sysadmin_role`;

CREATE TABLE `multimall_sysadmin_role` (
                                        `id` int(11) NOT NULL AUTO_INCREMENT,
                                        `name` varchar(63) NOT NULL COMMENT '角色名称',
                                        `desc` varchar(1023) DEFAULT NULL COMMENT '角色描述',
                                        `enabled` tinyint(1) DEFAULT '1' COMMENT '是否启用',
...
--
-- Table structure for table `multimall_aftersale`
--

DROP TABLE IF EXISTS `multimall_aftersale`;

CREATE TABLE `multimall_aftersale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_brand`
--

DROP TABLE IF EXISTS `multimall_brand`;

CREATE TABLE `multimall_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_cart`
--

DROP TABLE IF EXISTS `multimall_cart`;

CREATE TABLE `multimall_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_category`
--

DROP TABLE IF EXISTS `multimall_category`;

CREATE TABLE `multimall_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_collect`
--

DROP TABLE IF EXISTS `multimall_collect`;

CREATE TABLE `multimall_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `multimall_comment`
--

DROP TABLE IF EXISTS `multimall_comment`;

CREATE TABLE `multimall_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_coupon`
--

DROP TABLE IF EXISTS `multimall_coupon`;

CREATE TABLE `multimall_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_coupon_user`
--

DROP TABLE IF EXISTS `multimall_coupon_user`;

CREATE TABLE `multimall_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `multimall_feedback`
--

DROP TABLE IF EXISTS `multimall_feedback`;

CREATE TABLE `multimall_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `multimall_footprint`
--

DROP TABLE IF EXISTS `multimall_footprint`;

CREATE TABLE `multimall_footprint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `multimall_goods`
--

DROP TABLE IF EXISTS `multimall_goods`;

CREATE TABLE `multimall_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_goods_attribute`
--

DROP TABLE IF EXISTS `multimall_goods_attribute`;

CREATE TABLE `multimall_goods_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_goods_product`
--

DROP TABLE IF EXISTS `multimall_goods_product`;

CREATE TABLE `multimall_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `multimall_goods_specification`
--

DROP TABLE IF EXISTS `multimall_goods_specification`;

CREATE TABLE `multimall_goods_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `multimall_groupon`
--

DROP TABLE IF EXISTS `multimall_groupon`;

CREATE TABLE `multimall_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联multimall_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `multimall_groupon_rules`
--

DROP TABLE IF EXISTS `multimall_groupon_rules`;

CREATE TABLE `multimall_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_issue`
--

DROP TABLE IF EXISTS `multimall_issue`;

CREATE TABLE `multimall_issue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_keyword`
--

DROP TABLE IF EXISTS `multimall_keyword`;

CREATE TABLE `multimall_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_log`
--

DROP TABLE IF EXISTS `multimall_log`;

CREATE TABLE `multimall_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `admin` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管理员',
  `ip` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管理员地址',
  `type` int(11) DEFAULT NULL COMMENT '操作分类',
...
--
-- Table structure for table `multimall_order`
--

DROP TABLE IF EXISTS `multimall_order`;

CREATE TABLE `multimall_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_order_goods`
--

DROP TABLE IF EXISTS `multimall_order_goods`;

CREATE TABLE `multimall_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_region`
--

DROP TABLE IF EXISTS `multimall_region`;

CREATE TABLE `multimall_region` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_search_history`
--

DROP TABLE IF EXISTS `multimall_search_history`;

CREATE TABLE `multimall_search_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
--
-- Table structure for table `multimall_shop`
--

DROP TABLE IF EXISTS `multimall_shop`;

CREATE TABLE `multimall_shop`
(
    `id`     int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_storage`
--

DROP TABLE IF EXISTS `multimall_storage`;

CREATE TABLE `multimall_storage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_store`
--

DROP TABLE IF EXISTS `multimall_store`;

CREATE TABLE `multimall_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL COMMENT '商铺名称',
  `country` varchar(255) DEFAULT NULL COMMENT '商铺所在国家',
  `province` varchar(255) DEFAULT NULL COMMENT '商铺所在省份',
  `city` varchar(255) DEFAULT NULL COMMENT '商铺所在城市',
  `district` varchar(255) DEFAULT NULL COMMENT '商铺所在区',
  `address` varchar(255) DEFAULT NULL COMMENT '商铺所在详细地址',
  `images` varchar(255) DEFAULT NULL COMMENT '商铺介绍图',
  `logo` varchar(255) DEFAULT NULL COMMENT '商铺logo',
  `intro` varchar(255) DEFAULT NULL COMMENT '商铺介绍',
  `create_time` datetime DEFAULT NULL COMMENT '商铺创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '商铺修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


--
-- Table structure for table `multimall_system`
--

DROP TABLE IF EXISTS `multimall_system`;

CREATE TABLE `multimall_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_topic`
--

DROP TABLE IF EXISTS `multimall_topic`;

CREATE TABLE `multimall_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `multimall_user`
--

DROP TABLE IF EXISTS `multimall_user`;

CREATE TABLE `multimall_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
