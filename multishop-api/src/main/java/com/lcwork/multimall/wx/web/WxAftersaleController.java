...
public class WxAftersaleController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<MultimallAftersale> aftersaleList = aftersaleService.queryList(userId, status, page, limit, sort, order);

        List<Map<String, Object>> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (MultimallAftersale aftersale : aftersaleList) {
            List<MultimallOrderGoods> orderGoodsList = orderGoodsService.queryByOid(aftersale.getOrderId());
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer orderId) {
        ...
        MultimallAftersale aftersale = aftersaleService.findByOrderId(userId, orderId);
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody MultimallAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
     ...
     */
    @PostMapping("cancel")
    public Object cancel(@LoginUser Integer userId, @RequestBody MultimallAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        ...
        MultimallAftersale aftersaleOne = aftersaleService.findById(userId, id);
    ...
    private Object validate(MultimallAftersale aftersale) {
