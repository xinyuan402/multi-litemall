...
import com.lcwork.multimall.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(MultimallComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody MultimallComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<MultimallComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (MultimallComment comment : commentList) {
