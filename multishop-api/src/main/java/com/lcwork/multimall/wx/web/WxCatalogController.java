...
public class WxCatalogController {
    ...
    public Object getSecondCategory(@NotNull Integer id) {
        // 所有二级分类目录
        List<MultimallCategory> currentSubCategory = categoryService.queryByPid(id);
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        MultimallCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<MultimallCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<MultimallCategory>> allList = new HashMap<>();
        List<MultimallCategory> sub;
        ...
        // 当前一级分类目录
        MultimallCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        MultimallCategory currentCategory = categoryService.findById(id);
        if (currentCategory == null) {
            return ResponseUtil.badArgumentValue();
        }
        List<MultimallCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
