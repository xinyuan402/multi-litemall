...
import com.lcwork.multimall.core.util.*;
...
import com.lcwork.multimall.wx.dto.WxLoginInfo;
import com.lcwork.multimall.wx.service.CaptchaCodeManager;
import com.lcwork.multimall.wx.service.CouponAssignService;
import com.lcwork.multimall.wx.service.UserTokenManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<MultimallUser> userList = userService.queryByUsername(username);
        MultimallUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        MultimallUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new MultimallUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if (!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                MultimallUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<MultimallUser> userList = userService.queryByMobile(mobile);
        MultimallUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
