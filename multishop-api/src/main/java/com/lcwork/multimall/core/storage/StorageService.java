package com.lcwork.multimall.core.storage;
...
public class StorageService {
     ...
     */
    public MultimallStorage store(InputStream inputStream, long contentLength, String contentType, String fileName) {
        String key = generateKey(fileName);
        storage.store(inputStream, contentLength, contentType, key);

        String url = generateUrl(key);
        MultimallStorage storageInfo = new MultimallStorage();
