...
import com.lcwork.multimall.admin.vo.CatVo;
...
import static com.lcwork.multimall.admin.util.AdminResponseCode.GOODS_NAME_EXIST;
...
public class AdminGoodsService {
    ...
    @Autowired
    private MultimallGoodsSpecificationService specificationService;
    @Autowired
    private MultimallGoodsAttributeService attributeService;
    @Autowired
    ...
    private Object validate(GoodsAllinone goodsAllinone) {
        MultimallGoods goods = goodsAllinone.getGoods();
        ...
        MultimallGoodsAttribute[] attributes = goodsAllinone.getAttributes();
        for (MultimallGoodsAttribute attribute : attributes) {
        ...
        MultimallGoodsSpecification[] specifications = goodsAllinone.getSpecifications();
        for (MultimallGoodsSpecification specification : specifications) {
        ...
        MultimallGoodsProduct[] products = goodsAllinone.getProducts();
        for (MultimallGoodsProduct product : products) {
    ...
    @Transactional
    public Object delete(MultimallGoods goods) {
    ...
    public Object list2() {
        ...
        for (MultimallCategory l1 : l1CatList) {
            CatVo l1CatVo = new CatVo();
            l1CatVo.setValue(l1.getId());
            l1CatVo.setLabel(l1.getName());

            List<MultimallCategory> l2CatList = categoryService.queryByPid(l1.getId());
            List<CatVo> children = new ArrayList<>(l2CatList.size());
            for (MultimallCategory l2 : l2CatList) {
        ...
        // 管理员设置“所属品牌商”
        List<MultimallBrand> list = brandService.all();
        List<Map<String, Object>> brandList = new ArrayList<>(l1CatList.size());
        for (MultimallBrand brand : list) {
    ...
    public Object detail(Integer id) {
        ...
        List<MultimallGoodsProduct> products = productService.queryByGid(id);
        List<MultimallGoodsSpecification> specifications = specificationService.queryByGid(id);
        List<MultimallGoodsAttribute> attributes = attributeService.queryByGid(id);

        Integer categoryId = goods.getCategoryId();
        MultimallCategory category = categoryService.findById(categoryId);
