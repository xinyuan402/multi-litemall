...
import com.lcwork.multimall.admin.service.LogHelper;
...
import com.lcwork.multimall.db.service.MultimallAftersaleService;
...
import com.lcwork.multimall.db.util.AftersaleConstant;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private MultimallGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<MultimallAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody MultimallAftersale aftersale) {
        Integer id = aftersale.getId();
        MultimallAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for (Integer id : ids) {
            MultimallAftersale aftersale = aftersaleService.findById(id);
            if (aftersale == null) {
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody MultimallAftersale aftersale) {
        Integer id = aftersale.getId();
        MultimallAftersale aftersaleOne = aftersaleService.findById(id);
        if (aftersaleOne == null) {
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody MultimallAftersale aftersale) {
        Integer id = aftersale.getId();
        MultimallAftersale aftersaleOne = aftersaleService.findById(id);
        if (aftersaleOne == null) {
            return ResponseUtil.badArgumentValue();
        ...
        MultimallOrder order = orderService.findById(orderId);
