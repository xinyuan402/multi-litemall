...
import com.lcwork.multimall.db.service.MultimallIssueService;
...
public class AdminIssueController {
    ...
    @Autowired
    private MultimallIssueService issueService;
    ...
    public Object list(String question,
        ...
        List<MultimallIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(MultimallIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody MultimallIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        MultimallIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody MultimallIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody MultimallIssue issue) {
