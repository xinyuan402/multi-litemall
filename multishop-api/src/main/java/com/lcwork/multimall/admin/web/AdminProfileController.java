...
public class AdminProfileController {
    ...
    public Object lsNotice(String title, String type,
        ...
        List<MultimallAdminNoticeAdmin> noticeList = noticeAdminService.querySelective(title, type, getAdminId(), page, limit, sort, order);
    ...
    public Object catNotice(@RequestBody String body) {
        ...
        MultimallAdminNoticeAdmin noticeAdmin = noticeAdminService.find(noticeId, getAdminId());
        if (noticeAdmin == null) {
        ...
        MultimallAdminNotice notice = noticeService.findById(noticeId);
        ...
        if (adminId.equals(0)) {
            ...
            MultimallAdmin admin = adminService.findById(notice.getAdminId());
